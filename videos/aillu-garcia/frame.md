...
description: >
  ...
  ink black / warm cream), Raleway uppercase tracked + Raleway body, the 45° diagonal hatch,
...
typography:
  ...
  body:          { fontFamily: "Raleway", cqw: 1.0,  weight: 300, lineHeight: 1.7 }
  body-light:    { fontFamily: "Raleway", cqw: 1.5,  weight: 300, lineHeight: 1.5, note: "pull-quote voice" }
  section-label: { fontFamily: "Raleway", px: 12, weight: 700, tracking: "4px", upper: true }
  item-label:    { fontFamily: "Raleway", px: 11, weight: 700, tracking: "3px", upper: true }
  quote-attribution: { fontFamily: "Raleway", px: 14, weight: 600, tracking: "3px", upper: true }
  quote-role:    { fontFamily: "Raleway", px: 12, weight: 300, tracking: "1px" }
  # — display / hero ramp (Raleway, uppercase, tracked) —
  card-title:    { fontFamily: "Raleway", cqw: 1.9, weight: 300, lineHeight: 1.1, tracking: "1px", upper: true }
  sidebar-value: { fontFamily: "Raleway", cqw: 2.3, weight: 300, lineHeight: 1.0, upper: true }
  bar-title:     { fontFamily: "Raleway", cqw: 2.3, weight: 300, lineHeight: 1.0, tracking: "2px", upper: true }
  card-stat:     { fontFamily: "Raleway", cqw: 2.5, weight: 300, lineHeight: 1.0, upper: true }
  column-title:  { fontFamily: "Raleway", cqw: 3.7, weight: 300, lineHeight: 1.0, tracking: "2px", upper: true }
  section-headline:{ fontFamily: "Raleway", cqw: 4.2, weight: 300, lineHeight: 1.0, tracking: "2px", upper: true }
  stat-numeral:  { fontFamily: "Raleway", cqw: 5.0, weight: 300, lineHeight: 1.0, upper: true }
  hero-title:    { fontFamily: "Raleway", cqw: 6.5, weight: 300, lineHeight: 0.9, tracking: "4px", upper: true }
  jumbo-feature: { fontFamily: "Raleway", cqw: 9.0, weight: 300, lineHeight: 1.0, tracking: "12px", upper: true }
  # — decorative —
  background-numeral: { fontFamily: "Raleway", cqw: 10.0, weight: 300, color: "rgba(0,0,0,0.12)", note: "wallpaper numeral inside a coral region" }
  giant-mark:    { fontFamily: "Raleway", cqw: 14.0, weight: 300, color: "rgba(0,0,0,0.35)", note: "decorative quote mark inside a coral region" }
...
components:
  ...
  info-bar:
    ...
    rounded: "0"
    shadow: "none"
    description: "Footer band beneath a feature region — Bebas title left, Raleway meta right."
---
...
- **Fonts** — already set to **Raleway** (display) / **Source Sans Pro** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{300, 600, 700, 800}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
The voice is a two-face hierarchy: **Raleway** — tall condensed caps, always uppercase, always
tracked (1–12px) — carries every headline, stat, title, and meta figure; **Raleway** carries every
body line, label, and attribution across weights 300–700. Bebas declares; Raleway explains. The
...
- **Bebas uppercase + tracking** on every display element; **Raleway** on every body/label.
...
Two ramps. The **reading ramp** (Raleway body 1.0cqw, body-light 1.5cqw, labels in px) carries copy
...
- **Every Bebas element is uppercase with ≥1px tracking** (2px standard, 4px hero, 12px jumbo). **Every Raleway label is uppercase, 1–4px tracked.** No italic, no underline, no sentence-case Bebas.
...
ink `section-label` eyebrow; an optional Raleway-300 support line ≤44cqw. **Accent** the coral ground
...
**Focal** a 2–3 line pull quote in `{colors.cream}` Raleway **weight 300** on the ink panel.
...
mark. **Fixed** Raleway-300 quote, ink panel, ink-on-coral mark. **Free** quote, attribution, mark
...
Bebas title, Raleway body, coral stat). **Accent** the three coral top borders + icon squares.
...
- Set every Bebas element **uppercase + tracked** (2px standard, 4px hero, 12px jumbo); every Raleway label uppercase, 1–4px.
...
- Don't render Bebas in sentence case or untracked; don't pair it with a non-Raleway body sans.
...
- **Raleway + Raleway via Google Fonts.** CJK pairing (ZCOOL XiaoWei / Yozai) carries over from the source's CJK section; Bebas runs ~20% wider in CJK.
